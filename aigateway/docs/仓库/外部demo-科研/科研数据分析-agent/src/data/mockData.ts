import { AgentStep, DatasetMeta, GroupStat, AnomalySample, ReportSection } from '../types';
...
export const DEFAULT_DATASET: DatasetMeta = {
  ...
  previewRows: [
    { id: '1', Sample_ID: 'SMP-0001', Group: 'Group A', Temperature_C: 45.2, Pressure_MPa: 2.12, Yield_Percent: 78.4, Performance_Score: 78.2 },
    { id: '2', Sample_ID: 'SMP-0002', Group: 'Group A', Temperature_C: 45.5, Pressure_MPa: 2.18, Yield_Percent: 79.1, Performance_Score: 79.0 },
    { id: '3', Sample_ID: 'SMP-0003', Group: 'Group B', Temperature_C: 50.1, Pressure_MPa: 2.45, Yield_Percent: 84.8, Performance_Score: 85.1 },
    { id: '4', Sample_ID: 'SMP-0004', Group: 'Group B', Temperature_C: 50.4, Pressure_MPa: 2.40, Yield_Percent: 85.2, Performance_Score: 84.9 },
    { id: '5', Sample_ID: 'SMP-0005', Group: 'Group C', Temperature_C: 55.0, Pressure_MPa: 2.65, Yield_Percent: 91.8, Performance_Score: 91.5 },
    { id: '6', Sample_ID: 'SMP-0006', Group: 'Group C', Temperature_C: 55.2, Pressure_MPa: 2.70, Yield_Percent: 92.4, Performance_Score: 92.1 },
  ],
};
...
export const PRESET_DATASETS: DatasetMeta[] = [
  DEFAULT_DATASET,
  {
    ...
    previewRows: [
      { id: '1', Alloy_ID: 'HEA-801', Anneal_Temp: 850, Tensile_Strength_MPa: 1240, Elongation_pct: 18.4 },
      { id: '2', Alloy_ID: 'HEA-802', Anneal_Temp: 900, Tensile_Strength_MPa: 1380, Elongation_pct: 21.2 },
    ],
  },
  {
    id: 'bio-03',
    ...
    previewRows: [
      { id: '1', Well_Index: 'W-A01', Dose_uM: 0.1, Viability_pct: 98.4 },
      { id: '2', Well_Index: 'W-A02', Dose_uM: 10.0, Viability_pct: 42.6 },
    ],
  },
];
...
export const DISTRIBUTION_CHART_DATA = [
...
export const ANOMALY_SCATTER_DATA = [
  ...
  { id: 11, sample: 'Sample #45109', pressure: 1.10, yield: 31.2, status: 'Anomaly', group: 'B', note: '溶剂比例异常 31.2%' },
