 ...
 * AI 投标顾问 Demo 数据模块
 *
 * 本文件为 AI 投标顾问参考 demo 的数据层移植：
 * - 类型定义：投标分析全流程所需的所有 interface 与 type（StepKey 取值顺序：
 *   overview → qualification → risks → evaluation → strategy → matrix → tasks → proposal → healthCheck → report）
 * - 示例数据：SAMPLE_COMPANY_PROFILES（3 个企业档案：it_company / medical_company / construction_company）
 *   与 SAMPLE_TENDERS（2 个标书：smart-city-it / hospital-medical）
 * - 工具函数：copyToClipboard 与 downloadTextAsFile
 * - 步骤元信息：STEP_ORDER 与 STEP_META
 *
 * 纯 TypeScript 数据模块，不依赖任何 React/Vue 框架。
 */

// ===================== 类型定义（移植自 demo types.ts） =====================
...
// ===================== 示例数据（移植自 demo sampleTenders.ts） =====================
...
export const SAMPLE_TENDERS: Record<string, TenderAnalysisResult> = {
  ...
  'construction-project': {
    ...
    rawTextPreview: `市城投集团【项目编号：JC-2026-GC-0077】滨江新城安置房（一期）及配套市政道路工程总承包（EPC）项目招标公告。工程投资概算9800万元，资金来源为自筹+专项债。评标方法为综合评分法（技术标40分，商务标20分，投标报价40分）。要求投标人具备建筑工程施工总承包一级及以上资质，近五年具有单项合同金额≥8000万元的房屋建筑工程或含市政配套总承包业绩至少2个。本项目拟采用装配式建筑与BIM全过程应用。投标截止时间：2026年10月10日09:00。`,
    overview: {
      projectName: '市滨江新城安置房（一期）及配套市政道路工程总承包（EPC）项目',
      tenderer: '市城市建设投资集团有限公司',
      projectCode: 'JC-2026-GC-0077',
      projectType: '建筑工程 & 市政施工',
      budget: '98,000,000.00 元（9800万元）',
      submissionDeadline: '2026年10月10日 09:00 (北京时间)',
      bidOpeningTime: '2026年10月10日 09:00 (市公共资源交易中心开标1厅)',
      deliveryPeriod: '合同签订后540个日历天内完成竣工验收并交付使用',
      bidBond: '800,000.00 元（80万元，须从基本账户转出）',
      evaluationMethod: '综合评分法（施工组织设计等技术标40分 + 商务资信与业绩20分 + 投标报价40分）',
      coreSummary: '这是一个安置房与市政道路打包的EPC总承包工程，最适合具备建筑工程施工总承包一级资质、拥有安置房/保障房或市政配套总承包同类业绩、资金与劳动力组织能力强的建筑总承包企业参与；核心竞争点在于施工组织设计与装配式BIM应用深度、项目经理执业资历与无在建承诺、工期质量安全承诺以及科学测算的最优投标报价。',
      sourceFile: '市滨江新城安置房（一期）及配套市政道路工程招标文件.pdf',
      fileIntegrityNote: '文件解析完整，包含招标公告、资格审查表、评标办法、工程量清单与图纸目录、技术标暗标编制要求，关键条款清晰。'
    },
    qualifications: [
      {
        id: 'cq1',
        category: '企业资质',
        requirement: '具备建筑工程施工总承包一级及以上资质，且安全生产许可证在有效期内',
        status: '已满足',
        riskLevel: 'low',
        supplementNeeded: '提供资质证书正副本扫描件、安全生产许可证及“全国建筑市场监管公共服务平台”查询截图',
        sourceQuote: '资格审查表第1项：“投标人须具有建筑工程施工总承包一级及以上资质，并持有有效的安全生产许可证。”'
      },
      {
        id: 'cq2',
        category: '企业业绩',
        requirement: '近五年（2021年至今）具备单项合同金额≥8000万元的房屋建筑工程或含市政配套总承包业绩至少2个',
        status: '待确认',
        riskLevel: 'medium',
        supplementNeeded: '需核查历史案例合同金额是否均≥8000万，提供中标通知书、合同关键页及竣工验收备案证明',
        sourceQuote: '资格审查表第3项：“投标人近五年须具有单项合同金额≥8000万元的房屋建筑或市政配套总承包项目业绩至少2份。”'
      },
      {
        id: 'cq3',
        category: '人员要求',
        requirement: '拟派项目经理须具备一级建造师（建筑工程）执业资格、安全生产考核合格证（B证），且无在建工程',
        status: '已满足',
        riskLevel: 'low',
        supplementNeeded: '提供一级建造师注册证书、B证、无在建工程承诺书及近6个月社保证明',
        sourceQuote: '投标人须知第3.5.2条：“拟派项目经理须具备一级建造师（建筑工程）资格并持有安全B证，中标后至竣工验收不得更换，且不得同时担任其他在建工程项目经理。”'
      },
      {
        id: 'cq4',
        category: '财务要求',
        requirement: '注册资本金不低于5000万元，提供近三年经审计的财务审计报告（无亏损），银行资信良好',
        status: '已满足',
        riskLevel: 'low',
        supplementNeeded: '提供2023-2025年度审计报告及银行出具的基本户资信证明',
        sourceQuote: '资格审查标准第2.1条：“具有良好的商业信誉和健全的财务会计制度，提供近三年经审计的财务报告。”'
      },
      {
        id: 'cq5',
        category: '其他要求',
        requirement: '本项目不接受联合体投标；投标人近三年无重大安全事故、无“信用中国”失信记录',
        status: '已满足',
        riskLevel: 'low',
        supplementNeeded: '截标前3日内下载“信用中国”信用信息报告并附住建部门无重大安全事故证明',
        sourceQuote: '招标公告第5条：“本项目不接受联合体投标；近三年内未发生过较大及以上安全生产事故。”'
      }
    ],
    risks: [
      {
        id: 'cr1',
        title: '投标保证金80万元从非基本账户转出或逾期到账导致直接废标',
        riskLevel: 'high',
        category: '投标保证金',
        originalQuote: '投标人须知前附表第16项：“投标保证金人民币80万元整，须于2026年10月10日08:30前由投标人基本存款账户一次性汇入指定账户。未按规定转出或逾期到账者，其投标文件作否决投标处理。”',
        riskExplanation: '工程建设招标中最常见的一票否决项。若通过一般户、个人垫付或跨行延迟导致截止前未生成银行回执，将直接废标。',
        suggestedAction: '建议在截标前5天（10月5日前）完成基本户网银电汇并取得银行电子回单，将开户许可证与回单装订于商务标显著位置。'
      },
      {
        id: 'cr2',
        title: '拟任项目经理同时担任其他在建工程项目经理（一票否决）',
        riskLevel: 'high',
        category: '人员资格',
        originalQuote: '招标文件否决投标条款第2条：“拟派项目经理在全国建筑市场监管公共服务平台存在在建工程记录，且未提供合法解除或变更证明的，作无效投标处理。”',
        riskExplanation: '项目经理在建工程重复任职是住建领域电子化审查自动拦截的高频废标点，电子系统开标时自动比对。',
        suggestedAction: '截标前在“四库一平台”核对赵工的注册执业状态，开具无在建工程承诺书并附平台查询截图。'
      },
      {
        id: 'cr3',
        title: '工程量清单缺项漏项或报价出现重大偏差',
        riskLevel: 'high',
        category: '报价要求',
        originalQuote: '评标办法附则第3条：“投标报价不得低于成本，且分部分项工程量清单综合单价与招标控制价相比出现明显不平衡报价的，评标委员会有权要求澄清，无法合理说明的按废标处理。”',
        riskExplanation: '总承包EPC报价涉及土建、安装、市政道路多个专业，漏项或严重不平衡报价会被认定为不响应招标文件。',
        suggestedAction: '组织造价工程师逐项复核工程量清单与图纸，建立“清单-定额-主材价格”三级校验表，避免漏项。'
      },
      {
        id: 'cr4',
        title: '投标总报价超出招标控制价9800万元或明显低于成本',
        riskLevel: 'medium',
        category: '报价要求',
        originalQuote: '投标人须知第12.3条：“投标总报价不得超过招标控制价9800万元，否则按无效投标处理。”',
        riskExplanation: '超控制价直接废标；报价过低可能触发成本澄清程序，需在2小时内提供成本测算说明。',
        suggestedAction: '以9200万~9480万元（控制价93%~96%）为最优报价区间测算，准备《施工成本测算与让利依据说明书》备用。'
      },
      {
        id: 'cr5',
        title: '技术标（暗标）出现投标人名称、标识或格式违规',
        riskLevel: 'medium',
        category: '文件格式',
        originalQuote: '编制规范第7条：“技术标采用暗标评审，不得出现任何可识别投标人身份的文字、符号、印章或水印，否则技术标得分为0。”',
        riskExplanation: '暗标一旦暴露身份直接技术标0分，是评委评审中最无情的“一票否决”。',
        suggestedAction: '技术标统一使用招标文件规定的暗标字体字号，封面只填写标段编号，交由专人逐页审查去标识化。'
      }
    ],
    evaluationScores: [
      {
        ...
        category: '技术评分',
        maxScore: 25,
        criteria: '施工总体部署、主要分项工程施工方案、关键工序工艺、冬雨季施工与应急预案等，优（21-25分）、良（16-20分）、一般（10-15分）',
        currentStatus: '具备标准施工组织设计模板，装配式施工与市政交叉作业方案需深化',
        expectedScore: 21,
        improvementPotential: 4,
        improvementTips: '针对安置房铝模+爬架+装配式叠合板工艺绘制专项施工图，增加市政道路与房建交叉作业工序衔接图，冲刺24分以上。'
      },
      {
        id: 'cs2',
        name: '项目班子配置与人员资历',
        category: '人员配置',
        maxScore: 10,
        criteria: '项目经理一级建造师+B证得4分；技术负责人高级职称得2分；专职安全员配备及五大员齐全得2分；同类业绩项目经理得2分',
        currentStatus: '赵工（一建+B证 4分）+ 孙总工（高级职称 2分）+ 五大员齐全（2分）',
        expectedScore: 8,
        improvementPotential: 2,
        improvementTips: '优先选派具有安置房同类项目经理业绩的骨干任项目经理，争取2分满分。'
      },
      {
        id: 'cs3',
        name: 'BIM技术与装配式建筑应用',
        category: '技术评分',
        maxScore: 5,
        criteria: 'BIM全过程应用方案、装配率落实情况、智慧工地管理平台，按先进性分档给分',
        currentStatus: '具备BIM基础能力，但装配式深化设计与智慧工地方案偏薄',
        expectedScore: 3,
        improvementPotential: 2,
        improvementTips: '编制BIM+装配式建造专项方案，附既往项目BIM模型渲染图与智慧工地平台实景截图。'
      },
      {
        id: 'cs4',
        name: '企业综合实力与信用评价',
        category: '商务评分',
        maxScore: 10,
        criteria: '资质等级（一级5分）、企业信用AAA/重合同守信用（2分）、省市级奖项（2分）、安全文明工地（1分）',
        currentStatus: '房建总承包一级（5分）+ AAA信用（2分）+ 省级优质工程奖（2分）',
        expectedScore: 9,
        improvementPotential: 1,
        improvementTips: '补充省级安全文明标准化工地证书争取满分。'
      },
      {
        id: 'cs5',
        name: '类似工程业绩',
        category: '项目业绩',
        maxScore: 10,
        criteria: '近五年单项合同≥8000万房屋建筑或市政配套总承包业绩，每提供1个得2.5分，最高10分',
        currentStatus: '具备1个7800万生物医药产业园案例（未达8000万门槛）及1个3200万装修改造案例',
        expectedScore: 5,
        improvementPotential: 5,
        improvementTips: '深挖近五年合同库，寻找含市政配套或土建总包的≥8000万合同，或用合同+补充协议合并计算。'
      },
      {
        id: 'cs6',
        name: '投标报价（基准价法）',
        category: '价格评分',
        maxScore: 40,
        criteria: '满足招标文件要求且投标价格最低的投标报价为评标基准价，得满分40分。其他投标人得分=(评标基准价/投标报价)×40',
        currentStatus: '预计以9280万元测算（预估基准价在9150万左右）',
        expectedScore: 37,
        improvementPotential: 3,
        improvementTips: '按控制价93%~96%区间精准测算，兼顾利润与价格得分平衡，将价格分损失控制在2分以内。'
      }
    ],
    strategy: {
      mustPassItems: [
        '投标保证金80万元必须于10月10日08:30前从基本账户电汇到账',
        '拟任项目经理赵工在全国建筑市场监管公共服务平台必须无在建工程记录',
        '投标总报价严格不得超过招标控制价9800万元',
        '技术标暗标不得出现任何可识别投标人身份的信息'
      ],
      coreScoringItems: [
        '施工组织设计（25分）是拉开分差的主战场，需围绕装配式建造与市政交叉作业做深度定制',
        '投标报价（40分）权重最高，必须建立基准价博弈模型精准测算',
        '类似业绩（10分）每多一个合格案例拉开2.5分'
      ],
      competitiveGapItems: [
        '同类业绩数量：对手可能有3-4个≥8000万案例（10分），我方目前仅1个达标边缘案例（2.5分），分差最高5分',
        '市政公用工程施工总承包资质仅为二级，涉及市政道路部分可能被扣分',
        'BIM+装配式应用深度：行业头部企业普遍具备装配率50%以上落地案例'
      ],
      bonusItems: [
        '提供BIM应用省级示范项目或智慧工地观摩工地佐证可作为加分项',
        '拟派项目经理具备同类安置房业绩或市级以上优秀项目经理称号可争取满分'
      ],
      actionableTactics: [
        {
          title: '业绩补强：联合核查历史合同增补协议与结算单',
          detail: '紧急复核近五年已完工项目，重点查验7800万产业园项目是否有市政配套增补或结算调增，使其达到8000万门槛，挽回2.5分。',
          estimatedGain: '+2.5分',
          priority: 'high'
        },
        {
          title: '方案突围：施工组织设计从“通用模板”升级为“装配式+市政交叉”定制方案',
          detail: '针对安置房铝模爬架装配式工艺与市政道路管网交叉作业难点，绘制专项施工组织网络图与工序衔接图，力争技术分超越对手3-5分。',
          estimatedGain: '+3.5分',
          priority: 'high'
        },
        {
          title: '报价博弈：锁定最优报价区间9260万元',
          detail: '按近三年同类安置房EPC中标折扣率（92%~95%）结合土建+市政成本（约8400万）测算，将报价设定为9260万元，确保利润率8.5%同时实现综合得分最大化。',
          estimatedGain: '+2.0分',
          priority: 'high'
        },
        {
          title: '人员顶配：绑定具有安置房业绩的一建项目经理',
          detail: '若赵工在全国平台存在在建记录风险，立即启用备用项目经理并提前办结变更手续，锁定人员项满分。',
          estimatedGain: '+2.0分',
          priority: 'medium'
        },
        {
          title: 'BIM加分：制作BIM+智慧工地专项方案',
          detail: '在技术标第3章编排BIM全过程应用与智慧工地管理专项章节，附既往项目模型截图与工地实景，冲刺5分项。',
          estimatedGain: '+1.5分',
          priority: 'low'
        }
      ]
    ...
    capabilityMatrix: [
      {
        id: 'cm1',
        requirement: '建筑工程施工总承包一级资质及有效安全生产许可证',
        companyCapability: '具备房建施工总承包一级资质，安全生产许可证有效期内，三体系认证齐全',
        matchScore: 100,
        gap: '无缺口，完全满足',
        suggestion: '在商务标首页放置资质证书彩色扫描件及住建部平台查询截图',
        status: 'fully_matched'
      },
      {
        id: 'cm2',
        requirement: '近五年单项合同≥8000万类似工程业绩至少2个',
        companyCapability: '具备1个7800万产业园项目（已验收）+ 1个3200万装修改造项目（未达门槛）',
        matchScore: 65,
        gap: '缺少第2个单项合同≥8000万的总承包业绩（存在2.5~5分被扣风险）',
        suggestion: '核实7800万项目是否存在市政配套增补或结算调增可合并达标，或补充其他土建总包合同',
        status: 'partially_matched'
      },
      {
        id: 'cm3',
        requirement: '拟派项目经理一级建造师（建筑工程）+安全B证+无在建工程',
        companyCapability: '赵工持一建（建筑）电子注册证书及B证，注册状态正常，具备安置房总承包管理经验',
        matchScore: 100,
        gap: '无缺口',
        suggestion: '截标前在“四库一平台”核验无在建状态并附查询截图与无在建承诺书',
        status: 'fully_matched'
      },
      {
        id: 'cm4',
        requirement: '具备市政公用工程施工与配套能力（道路、管网）',
        companyCapability: '持有市政公用工程施工总承包二级资质，近三年承担过市政道路配套工程',
        matchScore: 85,
        gap: '市政资质为二级，大型道路管网工程经验相对薄弱',
        suggestion: '在技术标中突出市政道路分包组织方案与既有市政配套业绩佐证',
        status: 'partially_matched'
      },
      {
        id: 'cm5',
        requirement: '具备装配式建筑与BIM全过程应用能力',
        companyCapability: '拥有BIM深化团队及1个装配式叠合板施工案例，未获得省级BIM示范项目',
        matchScore: 70,
        gap: '装配率落地项目数量少，BIM应用深度可被头部企业拉开差距',
        suggestion: '联合BIM咨询单位编制装配式深化与智慧工地专项方案，补充模型渲染与工地实景素材',
        status: 'partially_matched'
      }
    ],
    combatTasks: [
      {
        id: 'ct1',
        task: '基本账户缴纳投标保证金80万元并获取银行电子回单',
        owner: '财务部 - 周会计',
        deadline: '2026-10-05 (截标前5天)',
        priority: 'high',
        status: 'pending',
        note: '必须走基本账户网银转账，核对附言项目编号 JC-2026-GC-0077'
      },
      {
        id: 'ct2',
        task: '核验项目经理赵工“四库一平台”无在建状态并开具承诺书',
        owner: '人力资源部 - 吴主管',
        deadline: '2026-10-06',
        priority: 'high',
        status: 'in_progress',
        note: '截屏存档无在建查询结果，同步准备备用项目经理全套资料'
      },
      {
        id: 'ct3',
        task: '施工组织设计与装配式BIM专项方案编制',
        owner: '技术部 - 孙总工',
        deadline: '2026-10-07',
        priority: 'high',
        status: 'in_progress',
        note: '重点绘制市政交叉作业工序衔接图与装配式施工网络图'
      },
      {
        id: 'ct4',
        task: '工程量清单复核与投标报价测算',
        ...
        priority: 'high',
        status: 'pending',
        note: '锁定目标报价9260万元，复核清单缺项与不平衡报价风险'
      },
      {
        id: 'ct5',
        task: '技术标暗标排版、去标识化审查与全本投标文件装订密封',
        owner: '投标项目组全体',
        deadline: '2026-10-09 17:00',
        priority: 'high',
        status: 'pending',
        note: '暗标统一字体字号，逐页审查去标识化；正本1份副本6份双袋密封加盖骑缝章'
      }
    ],
    proposalOutline: [
      {
        ...
        chapterNumber: '第一章',
        title: '工程概况与施工总体部署',
        description: '全面阐述对安置房工程、市政道路工程的理解，明确总体施工部署、施工区段划分与流水安排。',
        keyRequirements: ['理解安置房民生工程定位与交付目标', '市政道路与房建交叉施工区段划分', '临时设施与总平面布置方案'],
        draftContent: '本项目包含安置房（一期）6栋高层住宅及配套市政道路、管网工程，总体按“先地下、后地上，先市政、后房建”的原则分区段组织平行流水施工...'
      },
      {
        id: 'cch2',
        chapterNumber: '第二章',
        title: '施工组织设计与主要施工方案（★重点评分项）',
        description: '详细设计桩基与基础、主体结构（铝模+爬架+装配式叠合板）、砌体装饰、机电安装及市政道路等关键施工方案。',
        correspondsToScoreItem: '技术评分 - 施工组织设计与施工方案 (满分25分)',
        scoreWeight: '25分 (核心分值项)',
        keyRequirements: ['装配式叠合板深化设计与吊装工艺', '市政道路管网与房建交叉作业工序衔接', '冬雨季施工与深基坑支护专项方案'],
        draftContent: '主体结构采用“铝模+附着式爬架+预制叠合板”组合工艺，标准层按5天/层组织流水；市政道路采用分段流水与房建室外管网穿插施工...'
      },
      {
        id: 'cch3',
        chapterNumber: '第三章',
        title: 'BIM全过程应用与智慧工地建设方案',
        description: '阐明BIM建模、深化设计、施工模拟、进度校核及智慧工地管理平台应用，突出装配式构件全过程管理。',
        correspondsToScoreItem: '技术评分 - BIM与装配式应用 (满分5分)',
        scoreWeight: '5分 (加分项)',
        keyRequirements: ['BIM模型与装配式构件二维码追溯', '智慧工地（实名制/扬尘监测/塔吊监测）', '可视化交底与质量样板引路']
      },
      {
        id: 'cch4',
        chapterNumber: '第四章',
        title: '工程质量与安全生产保障体系',
        description: '建立质量保证体系与安全生产责任体系，明确创优目标（省优质结构工程/安全文明工地）。',
        correspondsToScoreItem: '技术评分 - 质量安全保证措施',
        keyRequirements: ['质量目标：省级优质结构工程', '安全目标：省级安全文明标准化工地', '危大工程专项方案与应急演练']
      },
      {
        id: 'cch5',
        chapterNumber: '第五章',
        title: '进度计划与资源配置保障',
        description: '制定540日历天施工总进度网络图与里程碑节点，配置劳动力、机械、材料资源计划。',
        correspondsToScoreItem: '技术评分 - 进度计划与资源保障',
        scoreWeight: '含在施工组织设计内',
        keyRequirements: ['540日历天总工期倒排网络计划', '关键线路与里程碑节点控制', '劳动力高峰及周转材料配置表']
      },
      {
        id: 'cch6',
        chapterNumber: '第六章',
        title: '总承包管理与竣工保修服务承诺',
        description: '阐述EPC总承包协调管理、分包管理及交付后两年保修与房屋质量回访承诺。',
        correspondsToScoreItem: '商务评分 - 服务与保修承诺',
        keyRequirements: ['总承包统筹管理与界面划分', '竣工资料移交与联合验收组织', '两年保修+质保金约定+回访机制']
      }
    ],
    healthCheck: {
      healthScore: 82,
      ...
      mediumRiskCount: 4,
      lowRiskCount: 3,
      summary: '投标文件框架完整，施工组织设计具备竞争力；但存在“单项≥8000万业绩不足”“市政资质二级”及“保证金/暗标格式”等需在提交前重点整改的事项。',
      dimensionChecks: {
        qualification: { title: '资格审查', status: 'pass', detail: '房建一级资质、安全生产许可证、财务审计报告均齐全合规' },
        commercial: { title: '商务响应', status: 'warning', detail: '单项≥8000万业绩仅1个边缘达标案例，可能损失2.5~5分' },
        technical: { title: '技术方案', status: 'pass', detail: '施工组织设计与装配式BIM专项方案已基本成形' },
        scoreCoverage: { title: '评分点覆盖', status: 'warning', detail: 'BIM与装配式应用深度不足，项目经理业绩加分项待补齐' },
        formatting: { title: '格式与暗标', status: 'warning', detail: '技术标暗标存在目录水印残留风险，需逐页去标识化审查' },
        consistency: { title: '六位一体一致性', status: 'pass', detail: '项目名称、项目编号、总工期、报价大小写校验无误' }
      },
      top10Issues: [
        {
          rank: 1,
          category: '资格',
          issue: '投标保证金80万元尚未打款，须确认由企业基本账户电汇',
          severity: 'high',
          location: '商务标 - 投标保证金缴纳凭证页',
          fixAdvice: '安排财务于10月5日前网银转账，附言准确的项目编号 JC-2026-GC-0077，并回贴电子回单。'
        },
        {
          rank: 2,
          category: '资格',
          issue: '拟任项目经理赵工需在“四库一平台”核验无在建工程记录',
          severity: 'high',
          location: '商务标 - 拟派项目经理资历表',
          fixAdvice: '截标前完成平台查询并附截图，同时准备备用项目经理全套证书以防不测。'
        },
        {
          rank: 3,
          category: '商务',
          issue: '案例《生物医药产业园1期》合同金额为7800万元，未达“≥8000万元”门槛',
          severity: 'medium',
          location: '商务标 - 近五年类似业绩证明材料',
          fixAdvice: '核查是否有市政配套增补或结算调增可合并达标，否则替换为其他合规土建总承包业绩。'
        },
        {
          rank: 4,
          category: '格式',
          issue: '技术标暗标封面残留公司水印与页码标识',
          severity: 'medium',
          location: '技术标 - 暗标封面及页眉页脚',
          fixAdvice: '清除全部公司标识、水印与页眉页脚，统一使用招标文件规定的暗标字体字号。'
        },
        {
          rank: 5,
          category: '技术',
          issue: '市政道路管网工程缺少专项施工方案章节',
          severity: 'medium',
          location: '技术标 - 主要施工方案',
          fixAdvice: '补充市政道路路基、管网与房建室外工程交叉施工专项方案及工序衔接图。'
        },
        {
          rank: 6,
          category: '评分',
          issue: 'BIM应用仅停留在建模层面，缺少施工模拟与智慧工地截图佐证',
          severity: 'medium',
          location: '技术标 - BIM与装配式应用章节',
          fixAdvice: '补充BIM施工模拟动画截图、预制构件二维码管理流程及智慧工地平台实景。'
        },
        {
          rank: 7,
          category: '一致性',
          issue: '投标函中投标有效期写为“90天”，招标文件要求“120日历天”',
          severity: 'high',
          location: '商务标 - 投标函',
          fixAdvice: '立即将投标有效期修改为“120日历天”，否则构成不响应招标文件。'
        },
        {
          rank: 8,
          category: '商务',
          issue: '装修改造案例（3200万元）与安置房类业绩关联度弱，业绩表需优化排序',
          severity: 'low',
          location: '商务标 - 业绩汇总表',
          fixAdvice: '业绩表按“房屋建筑工程→市政配套→装饰装修”排序，突出与招标项目同类度。'
        },
        {
          rank: 9,
          category: '技术',
          issue: '施工总进度网络图未标注装配式构件生产供货周期',
          severity: 'low',
          location: '技术标 - 进度计划',
          fixAdvice: '在网络图中增加构件深化-生产-运输-吊装的关键线路说明。'
        }
      ]
    },
    finalReport: {
      ...
      coreReasons: {
        qualificationMatchRate: 90,
        experienceMatchRate: 75,
        expectedScore: 82.5,
        maxScore: 100,
        primaryStrength: '房建施工总承包一级资质、安全生产与财务体系健全，项目经理一建+B证齐备且具备安置房管理经验',
        primaryWeakness: '单项合同≥8000万的总承包业绩仅1个边缘达标案例，市政配套能力（二级资质）相对薄弱，业绩项可能被拉开2.5~5分',
        maxDisqualificationRisk: '投标保证金必须从基本户汇出 + 项目经理在建工程核验 + 技术标暗标去标识化（三处一票否决红线）',
        maxScoreOpportunity: '施工组织设计通过装配式+BIM深度定制冲击24分高分档，配合9260万元最优博弈报价'
      },
      strategicVerdict: '【🟡 谨慎参与（需专项攻关）】该项目与企业房建总承包核心能力匹配度较高，资质门槛完全符合，但单项≥8000万业绩仅1个边缘案例、市政二级资质相对薄弱，在业绩与BIM应用两项存在明显失分风险。若能补齐业绩（+2.5分）并在施工组织设计上深度定制（+3.5分），预计综合总分可达82.5~86分，具备冲刺中标实力。关键前置动作为：10月5日前汇出保证金、核验项目经理无在建状态、完成暗标去标识化审查。',
      timestamp: '2026-08-29 11:50'
    }
  }
};

// ===================== 工具函数（移植自 demo utils.ts） =====================
...
export const STEP_ORDER: StepKey[] = ['overview','qualification','risks','evaluation','strategy','matrix','tasks','proposal','healthCheck','report'];

export const STEP_META: Record<StepKey, { label: string; short: string }> = {
  overview: { label: '项目概览', short: '概览' },
  qualification: { label: '资格预审', short: '资格' },
  risks: { label: '废标风险', short: '风险' },
  evaluation: { label: '评分拆解', short: '评分' },
  strategy: { label: '得分策略', short: '策略' },
  matrix: { label: '能力匹配', short: '能力' },
  tasks: { label: '作战任务', short: '任务' },
  proposal: { label: '技术标大纲', short: '方案' },
  healthCheck: { label: '标书体检', short: '体检' },
  report: { label: '作战报告', short: '报告' },
};