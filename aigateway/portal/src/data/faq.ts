...
export const faqData: FaqItem[] = [
  {
    id: 'faq-1',
    question: 'AI 员工和 Skill 有什么区别？',
    answer:
      'Skill 是通用能力，购买后即买即用，适合验证效果；AI 员工是学会了你公司业务的专属员工 —— 我们会把您的企业资质、历史投标文件、案例与产品资料训练进 AI 员工，按真实岗位（AI 投标经理、AI 外贸销售等）配置并持续调优。',
  },
  {
    id: 'faq-2',
    question: 'AI 员工是如何定制的？',
    answer:
      '三步完成：① 您提供企业资质、历史投标文件、企业案例、产品资料与人员信息；② 我们配置专属 AI 员工，学习企业数据并匹配业务流程；③ 持续服务：知识库维护、效果调优与月度支持。基础版 ¥9,800 起。',
  },
  {
    id: 'faq-3',
    question: '行业解决方案是怎么合作的？',
    answer:
      '面向工程投标、外贸出海、内容增长等行业，我们把多个 AI 员工编排成一套行业智能中心（如 AI 投标 + AI 合同 + AI 项目管理 + AI 经营分析）。按 Agent 数量、私有化部署、数据接入与集成复杂度报价，¥5 万起，可私有化部署。',
  },
  {
    id: 'faq-4',
  ...
  },
  {
    ...
    answer:
      '底层 API 采用按量计费模式，按实际 Token 消耗计费（区分输入和输出），无订阅费、无月费，注册即赠送体验额度；能力商城 Skill ¥99～999；AI 员工定制 ¥9,800 起；行业解决方案 ¥5 万起。详情请联系销售团队。',
  },
  {
    id: 'faq-8',
    question: '数据传输是否安全？会不会泄露我的 Prompt？',
    answer:
      'Nova AI Gateway 采用即时转发架构，不持久保存任何 Prompt 数据。所有传输均使用 TLS 1.3 加密。同时记录每一次 API 调用的元数据（不记录内容），满足企业合规需求。需要更高合规级别时，可选择私有化部署，数据不出企业。',
  },
  {
    id: 'faq-9',
  ...
  },
  {
    ...
    answer:
      '企业客户可享受：① 专属技术支持群（7×24h）；② 私有化部署方案；③ 月结账期与用量折扣；④ 专属架构师 1v1 支持。详情请联系售前团队。',
  },
  {
    id: 'faq-13',
